			...
			<div className="container mx-auto flex items-center h-24">
				...
				<nav className="contents font-semibold text-base lg:text-lg">
					<ul className="mx-auto flex items-center">
						...
						<li className="p-3 xl:p-5">
							<a href="">
								<span className="hover:text-green-600">About</span>
							</a>
						</li>
						<li className="p-3 xl:p-5">
							<a href="">
								<span className="hover:text-green-600">Projects</span>
							</a>
						</li>
						<li className="p-3 xl:p-5">
							<a href="">
								<span  className="hover:text-green-600">Services</span>
							</a>
						</li>
						<li className="p-3 xl:p-5">
							<a href="">
